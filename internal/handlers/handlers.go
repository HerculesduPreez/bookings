...
import (
	...
	"github.com/HerculesduPreez/bookings/internal/forms"
...
// Generals renders the Generals Room page and displays the form
func (m *Repository) Generals(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "generals.page.tmpl", &models.TemplateData{})
}

//Majors renders the Majors Room page and displays the form
...
//Post AvailabilityJSON handles request for JSON Response
